...
public class ExtentReportFactory {
	...
	public static void sendReportByGMail(String... to) throws EmailException 
	{
		EmailAttachment attachment = new EmailAttachment();
		  ...
		  if(to.length==0){
			  //send it to person
			  email.addTo("karthik.r@jmrinfotech.com");
		  }else
		  {
			  email.addTo(to);
		  }
		  email.setAuthenticator(new DefaultAuthenticator("naveenkumar.k@jmrinfotech.com", "NVK@jmr123"));
		  email.setSSLOnConnect(true);
		  email.setFrom("naveenkumar.k@jmrinfotech.com", "JMR-MCB Automation Team");
		  email.setSubject("Automation Test Execution report for MCB");
